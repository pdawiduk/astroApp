...
public class WeatherFetcher extends IntentService {
    ...
    public WeatherFetcher(SharedPreferences sharedPreferences, Context context){
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                ...
                .appendQueryParameter(APPID_PARAM, getResources().getString(R.string.keyApi))
                .build();
    ...
    public static class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Intent sendIntent = new Intent(context, WeatherFetcher.class);
            sendIntent.putExtra(WeatherFetcher.LOCATION_QUERY_EXTRA, intent.getStringExtra(WeatherFetcher.LOCATION_QUERY_EXTRA));
